...
function Row({title, movies }: Props) {
    ...
    const [isMoved, setIsMoveed] = useState(false)
    ...
    return (
        <div className="h-40 space-y-0.5 md:space-y-2">
            ...
            <div className="group relative md:-ml-2">
                ...
                <div ref={rowRef} className='flex scrollbar-hide overflow-hidden items-center space-x-1.5 overflow-x-scroll md:space-x-2.5 md:p-2'>
                    {
                        movies.map((movie) =>(
